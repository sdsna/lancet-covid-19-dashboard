  ...
  <Box
    ...
    <Typography
      ...
      {/* TODO: Don't use javascript:void(0).
        ...
        */}
      <a href="#" onClick={() => alert("The boundaries, colors, denominations, and other information shown on this map do not imply any judgment on the part of SDSN concerning the legal status of any territory or the endorsement or acceptance of such boundaries.")}>
